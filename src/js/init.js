 ...
 * Pixabay API Key
 */
var API_KEY = '45129290-8360d1649faa930d064985985';
var GOOGLE_FONTS_API_KEY = 'AIzaSyAlVMGXdwTOggCs4-U7SS4V5v92nhXrobA';
...
/**
 * The local database to (auto)store the project
 * @type {Localbase}
 */
...
var duration = 30000;
/**
 * Array of keyframe objects, representing the animation keyframes added by users.
 * Each keyframe object contains the following properties:
 * @type {Array<{
*   t: number,          // The time of the keyframe in the animation timeline.
*   name: string,       // The name of the property being animated.
*   value: any,         // The value of the property at this keyframe.
*   id: string,         // The unique identifier of the object being animated.
*   easing: string      // The easing function used for the animation.
* }>}
*/
var keyframes = [];
/**
...
/**
 * Fabric.js canvas, the very canvas of this website
 * @type {fabric.Canvas}
 */
